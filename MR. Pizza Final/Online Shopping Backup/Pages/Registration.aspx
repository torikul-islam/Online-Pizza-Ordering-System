        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox CssClass="form-control" ID="txt_fname" runat="server" placeholder="Enter Full Name"></asp:TextBox>
                    
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_fname" ErrorMessage="Name is Required"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
