<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Product_description.aspx.cs" Inherits="Online_Shopping_Backup.Pages.Mobile_description" %>
            ...
            <div class="col-lg-6">
                ...
                <asp:DataList ID="DataList1" runat="server" DataKeyField="P_ID" DataSourceID="SqlDataSource1">
                    ...
                    <ItemTemplate>
                        ...
                        <span id="rs">Price: </span><asp:Label ID="MRPLabel" CssClass="price" runat="server" Text='<%# Eval("MRP") %>' />
                        <br />
                        <br />
                        <span id="brand_name">Size</span>
