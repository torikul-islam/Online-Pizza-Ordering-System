   ...
   <div class="row">
       <div class="col-lg-12">
           ...
           <Columns>
               ...
               <asp:BoundField DataField="Our_Prize" HeaderText="Sale Price" SortExpression="Our_Prize" />
               <asp:BoundField DataField="Discount" HeaderText="Discount" SortExpression="Discount" />
               <asp:BoundField DataField="Brand" HeaderText="Size" SortExpression="Brand" />
               <asp:BoundField DataField="Brand_image" HeaderText="Main Image" SortExpression="Brand_image" />
               <asp:BoundField DataField="Type_of_product" HeaderText="Category" SortExpression="Type_of_product" />
