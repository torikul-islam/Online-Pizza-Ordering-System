...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <asp:HyperLink CssClass="btn btn-primary" ID="hyper_link_forget_password" NavigateUrl="~/Pages/Registration.aspx" Text="Not registered? Sign Up" runat="server"></asp:HyperLink>
